package cn.ccoco.platform.monitor.service.impl;

import cn.ccoco.platform.common.entity.CCocoConstant;
import cn.ccoco.platform.common.entity.QueryRequest;
import cn.ccoco.platform.common.utils.AddressUtil;
import cn.ccoco.platform.common.utils.HttpContextUtil;
import cn.ccoco.platform.common.utils.IpUtil;
import cn.ccoco.platform.common.utils.SortUtil;
import cn.ccoco.platform.monitor.entity.LoginLog;
import cn.ccoco.platform.monitor.mapper.LoginLogMapper;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", CCocoConstant.ORDER_DESC, true);
