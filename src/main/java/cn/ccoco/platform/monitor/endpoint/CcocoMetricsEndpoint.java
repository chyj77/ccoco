 ...
 */
@CcocoEndPoint
public class CcocoMetricsEndpoint {

    private final MeterRegistry registry;

    public CcocoMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public CcocoMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new CcocoMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class CcocoMetricResponse {
        ...
        CcocoMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
