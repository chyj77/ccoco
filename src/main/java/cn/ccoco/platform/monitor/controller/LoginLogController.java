...
public class LoginLogController extends BaseController {
    ...
    public CcocoResponse loginLogList(LoginLog loginLog, QueryRequest request) {
    ...
    public CcocoResponse deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) {
