package cn.ccoco.platform.system.service.impl;
...
import cn.ccoco.platform.system.entity.UserDataPermission;
import cn.ccoco.platform.system.entity.UserRole;
import cn.ccoco.platform.system.mapper.UserMapper;
import cn.ccoco.platform.system.service.IUserDataPermissionService;
import cn.ccoco.platform.system.service.IUserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public IPage<User> findUserDetailList(User user, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "userId", CCocoConstant.ORDER_ASC, false);
    ...
    public void updateUser(User user) {
        ...
        User currentUser = CcocoUtil.getCurrentUser();
    ...
    public void regist(String username, String password) {
        ...
        ur.setRoleId(CCocoConstant.REGISTER_ROLE_ID);
    ...
    public void updateProfile(User user) {
        ...
        if (isCurrentUser(user.getId())) {
            ...
            throw new CcocoException("您无权修改别人的账号信息！");
        }
    }
